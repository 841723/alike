...
public class CodeBlock {
	...
	public CodeBlock getFirstInst() {
		CodeBlock firstInst = new CodeBlock();
		int i = -1;
		do {
			i++;
			firstInst.code.add(this.code.get(i));
		} while (i < this.code.size() && !(this.code.get(i) instanceof PCodeInstruction));
